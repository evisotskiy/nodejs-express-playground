...
exports.registerValidators = [
  ...
  body('confirm')
    ...
    .trim(),
  body('name').isLength({ min: 3 }).withMessage('Name should be longer than 3 symbols'),
];

exports.loginValidators = [body('email').isEmail().withMessage('Enter correct email').normalizeEmail()];

exports.courseValidators = [
  body('title').isLength({ min: 3 }).withMessage('Minimum title length is 3 symbols').trim(),
